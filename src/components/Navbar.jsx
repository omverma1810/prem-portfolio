    ...
    <div className={style.navbar_container}>
      <nav className={`${style.navbar} ${scrolled ? 'fixed' : ''}`}>
        ...
        <ul className={style.navlink}>
          ...
          <li>
            <a
              href="https://drive.google.com/file/d/14BYnbD-Bp3hA3hD_m-rqHcfGK_VLlJVl/view?usp=drivesdk"
              target=" blank"
        ...
        >
          ...
          <li>
            <motion.a
              ...
              initial="hidden"
              whileInView="show"
              href="https://drive.google.com/file/d/1KnlRawmv7j0fhC9EqeVenhxbeOnUwS_q/view?hl=en_GB"
              target=" blank"
